...
export const products: Product[] = [
  {
    id: 'p1', name: 'Flag', category: 'bières',
  ...
  {
    id: 'p3', name: 'GOLD', category: 'bières',
  ...
  {
    id: 'p7', name: 'Valmeras Rouge', category: 'vins',
    prices: { bouteille: 5000, verre: 1200 },
    activePriceFormats: ['bouteille', 'demi', 'quart', 'verre'],
  ...
  {
    id: 'p8', name: 'Valmeras Rosé', category: 'vins',
  ...
  {
    id: 'p12', name: 'Club 7', category: 'spiritueux',
    prices: { bouteille: 4000, verre: 500 },
  ...
  {
    id: 'p13', name: 'Gin', category: 'spiritueux',
    prices: { bouteille: 4000, verre: 500 },
    activePriceFormats: ['bouteille', 'quart', 'verre'],
  ...
  {
    id: 'p14', name: "Fanta ananas", category: 'softs',
    prices: { bouteille: 800 },
    activePriceFormats: ['bouteille'],
    unit: 'bouteille', stock: 12, stockUnit: 'bouteille', seuilAlerte: 6, seuilCritique: 3,
